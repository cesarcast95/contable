              ...
              <div class="card-header">
               ...
               <div class="row">
                  <div class="col-md-2">
                      ...
                      <a href="{{route('clientes.create')}}" class="btn btn-info" style="width: 100%">CREAR</a>
                  </div>
                  <div class="col-md-10" style="padding-top: 10px;"> 
                   <div style="display: block; float:right;">
                    {{Form::open(array(
                         'action' => 'ControllerClientes@filtro_clientes',
                         'method' => 'GET',
                         'role' => 'form',
                         'class' => 'form-inline'
                          ))
                  ...
                  <table class="table">
                    ...
                    @foreach($clientes as $data)
                      <tr>
                        <td>
                          <center>
                            <a href="{{route('clientes.edit', $data->id)}}" style="font-size: 35px; padding: 2px; padding-bottom: 0px;">
                        ...
                        <td>{{$data->tel}}</td>
                        <td>
                        {!! Form::open(['route' => ['clientes.destroy', $data->id]]) !!}

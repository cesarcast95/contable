          ...
          <div class="col-md-12">
            <div class="card" style="padding: 20px">
              <div class="card-header">
                <h4 class="card-title">CUENTAS DE PRESTAMOS</h4>
                <a href="{{route('cobros.create')}}" class="btn btn-info">CREAR</a>
              </div>
              <div class="card-body">
                  ...
                  <table class="table">
                    ...
                    <!--{{$tercero = App\Terceros::find($data->tercero)}}-->
                      <tr>
                        <td>
                          <center>
                            <a href="{{route('cobros.edit', $data->id)}}" style="font-size: 35px; padding: 2px; padding-bottom: 0px;">
                        ...
                        <td>$ {{number_format($data->libramiento)}}</td>
                        <td>{{$data->vencimiento}}</td>
                        <td>{{$data->caja}}</td>
                        <td>
                          {!! Form::open(['route' => ['cobros.destroy', $data->id]]) !!}

              ...
              <div class="card-header">
               ...
               <div class="row">
                  <div class="col-md-2">
                      ...
                      <a href="{{route('terceros.create')}}" class="btn btn-info" style="width: 100%">CREAR</a>
                  </div>
                  <div class="col-md-10" style="padding-top: 10px;"> 
                   <div style="display: block; float:right;">
                    {{Form::open(array(
                         'action' => 'TercerosController@filtro_terceros',
                         'method' => 'GET',
                         'role'   => 'form',
                         'class'  => 'form-inline'
                          ))
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table">
                    ...
                    <tbody>
                    @foreach($terceros as $data)
                      <tr>
                        <td>
                        <center>
                          <a href="{{route('terceros.edit', $data->id)}}" style="font-size: 35px; padding: 2px; padding-bottom: 0px;">
                        ...
                        <td>{{$data->celular}}</td>
                        <td>
                          {!! Form::open(['route' => ['terceros.destroy', $data->id]]) !!}

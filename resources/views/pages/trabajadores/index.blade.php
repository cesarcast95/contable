              ...
              <div class="card-header">
               ...
               <div class="row">
                  <div class="col-md-2">
                      ...
                      <a href="{{route('trabajadores.create')}}" class="btn btn-info" style="width: 100%">CREAR</a>
                  </div>
                  <div class="col-md-10" style="padding-top: 10px;"> 
                   <div style="display: block; float:right;">
                    {{Form::open(array(
                         'action' => 'ControllerTrabajadores@filtro_trabajadores',
                         'method' => 'GET',
                         'role' => 'form',
                         'class' => 'form-inline'
                          ))
                  ...
                  <table class="table">
                    ...
                    @foreach($trabajadores as $data)
                      <tr>
                        <td>
                        <center>
                          <a href="{{route('trabajadores.edit', $data->id)}}" style="font-size: 35px; padding: 2px; padding-bottom: 0px;">
                        ...
                        <td>{{$data->telefono}}</td>
                        <td>
                          {!! Form::open(['route' => ['trabajadores.destroy', $data->id]]) !!}
                    ...
                    @endforeach
                    {{ $trabajadores->appends(request()->input())->links() }}
                    </tbody>
                  </table>
                </div>
              </div>
